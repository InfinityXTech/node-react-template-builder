...
import { ReactFormGenerator } from './src/index.tsx';
...
> {
  constructor(props: any) {
    ...
    store.subscribe((state: any) => update(state.data));
  }
            ...
            <div className="modal-dialog modal-lg" role="document">
              <div className="modal-content">
                <ReactFormGenerator
                  ...
                  locale='en' display_short={false} validateForCorrectness={false} read_only={false} submitButton={false} intl={undefined}/>
            ...
            <div className="modal-dialog modal-lg">
              <div className="modal-content">
                <ReactFormGenerator
                  ...
                  hide_actions={true}
                  data={this.state.data}
                  locale='en' skip_validations={false} display_short={false} validateForCorrectness={false} submitButton={false} intl={undefined}/>
            ...
            <div className="modal-dialog modal-lg">
              <div className="modal-content border border-light p-3 mb-4">
                <ReactFormGenerator
                  ...
                  variables={this.props.variables}
                  hide_actions={false}
                  locale='en' skip_validations={false} validateForCorrectness={false} read_only={false} submitButton={false} intl={undefined}                  />
