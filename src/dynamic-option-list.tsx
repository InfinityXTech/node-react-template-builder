...
export interface DynamicOptionListProps {
  element: any;
  data: any;
  updateElement: any;
  preview: any;
...
export default class DynamicOptionList extends React.Component<
  DynamicOptionListProps,
  DynamicOptionListState
> {
  ...
  editOption(option_index: any, e: any) {
  ...
  editValue(option_index: any, e: any) {
    const this_element = this.state.element;
    const val =
      e.target.value === ""
        ? this._setValue(this_element.options[option_index].text)
  ...
  editOptionCorrect(option_index: any, e: any) {
    const this_element = this.state.element;
          ...
          <li>
            <div className="row">
              <div className="col-sm-6">
                <b>
                  <IntlMessages id={this.props.optionLabel} />
                </b>
              </div>
              {this.props.canHaveOptionValue && (
                <div className="col-sm-2">
                  <b>
                    <IntlMessages id={this.props.valueLabel} />
                  </b>
                </div>
              )}
              {this.props.canHaveOptionValue &&
                this.props.canHaveOptionCorrect && (
                  <div className="col-sm-4">
                    <b>
                      <IntlMessages id={this.props.correctLabel} />
                    </b>
                  </div>
                )}
            </div>
          </li>
          {this.props.element.options.map((option: any, index: any) => {
