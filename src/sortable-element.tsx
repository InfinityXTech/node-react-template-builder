...
// import { PlaceHolderProps } from './form-place-holder.tsx';
...
const cardTarget = {
  ...
  hover(props: any, monitor: any, component: any) {
    ...
    const el: any = findDOMNode(component);
...
export default function (ComposedComponent: any) {
  ...
  const x = DropTarget<CardProps>([ItemTypes.CARD, ItemTypes.BOX], cardTarget, connect => ({
    connectDropTarget: connect.dropTarget(),
  }))(Card);

  return DragSource<CardProps>(ItemTypes.CARD, cardSource, (connect, monitor) => ({
